...
import by.artem.store.tools.sort.comparator.ProductNameComparator;
import by.artem.store.tools.sort.comparator.ProductPriceComparator;
import by.artem.store.tools.sort.comparator.ProductRateCompator;
