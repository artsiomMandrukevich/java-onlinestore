...
import by.artem.store.database.DataBase;
import by.artem.store.database.SQLStatements;
import by.artem.store.tools.sort.SortValues;
import by.artem.store.tools.sort.XmlParser;
...
import static by.artem.store.database.SQLInstructions.*;
import static by.artem.store.tools.sort.StoreComparator.PATH_TO_XML_SORT_CONFIG;
